def main():
    ...
    basepath="C:/Users/Admin/Desktop/Deepfake Detection Project 100% code/image/real-and-fake-face-detection-master/dataset/dataset"
    ...
    val_steps = int( np.ceil(testing_set.samples / 32) )
    ...
    #Saving the model
    #import h5py
    classifier.save(basepath + '/deepfake_model.h5')
    
    
    scores = classifier.evaluate(testing_set, verbose=1)
